# Stephen first-play audit — stephen-first-play-2026-06-08T21-03-53-161Z

* Base URL: http://127.0.0.1:8088/autotable/  (NO query parameters)
* Started: 2026-06-08T21:03:53.162Z
* Ended:   2026-06-08T21:06:39.832Z
* Page errors: 0
* Console errors: 3
...
* ✅ Phase A: Landing (bare URL, no query params) — 4739 ms
* ✅ Phase B: Dismissals (Skip Tour + Skip Onboarding) — 1287 ms
* ✅ Phase C: Lobby picks (Changsha + 3 bots + seat 0) — 3183 ms
* ✅ Phase D: Apply & Start (navigate) — 4895 ms
* ✅ Phase D2: Click Connect (manual) — 64 ms
* ✅ Phase E: Take seat (manual fallback if auto-seat skipped) — 3122 ms
* ✅ Phase F: Deal — hold-to-confirm 700ms on #deal — 10543 ms
* ✅ Phase G: My hand populated — 1890 ms
* ✅ Phase H: Discard — human-style click on hand tile — 3661 ms
* ✅ Phase H2: Click #pickup-take-btn → does pickup phase advance? — 87 ms
* ✅ Phase I: Bot draw + discard cadence (30s) — 30524 ms
* ✅ Phase J: Claim window visibility — 20468 ms
* ✅ Phase K: Sustained play observation (60s) — 60514 ms
* ✅ Phase L: Final UI inventory — 1614 ms
* ✅ Phase M: #deal single-click + disabled tooltip (FIX 4) — 19984 ms
