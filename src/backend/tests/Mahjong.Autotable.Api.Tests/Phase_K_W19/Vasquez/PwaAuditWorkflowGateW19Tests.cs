...
/// <summary>
/// Phase K Wave 19 — Vasquez self-lane. PWA-Audit workflow
/// gate W19 follow-up: confirm Apone W18's
/// <c>--form-factor=desktop</c> + <c>--screenEmulation.mobile=false</c>
/// flags are STILL in <c>.github/workflows/pwa-audit.yml</c>
/// (no W19 regression).
/// </summary>
public sealed class PwaAuditWorkflowGateW19Tests
{
    ...
    [Fact, Trait("Category", "SelfLane"), Trait("Wave", "Phase-K-19"), Trait("Lane", "Vasquez")]
    public void PwaAudit_FormFactorDesktop_Flag_StillPresent_W19()
    {
    ...
    [Fact, Trait("Category", "SelfLane"), Trait("Wave", "Phase-K-19"), Trait("Lane", "Vasquez")]
    public void PwaAudit_ScreenEmulationMobileFalse_Flag_StillPresent_W19()
    {
        var text = File.ReadAllText(PwaAuditPath());
    ...
    [Fact, Trait("Category", "SelfLane"), Trait("Wave", "Phase-K-19"), Trait("Lane", "Vasquez")]
    public void PwaAudit_Lighthouse_Token_StillPresent_W19()
    {
        var text = File.ReadAllText(PwaAuditPath());
