        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromSeason = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    ToSeason = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    DeferredAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TournamentId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DrainedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
