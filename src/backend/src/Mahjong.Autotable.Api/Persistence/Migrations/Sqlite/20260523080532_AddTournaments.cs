        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Channel = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    PlayerId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    OldTokenId = table.Column<Guid>(type: "TEXT", nullable: false),
                    NewTokenId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Ipv4Hash = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotatedFromTokenId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByPlayerId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1Id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Player2Id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
                    Player3Id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    Player4Id = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    WinnerPlayerId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
