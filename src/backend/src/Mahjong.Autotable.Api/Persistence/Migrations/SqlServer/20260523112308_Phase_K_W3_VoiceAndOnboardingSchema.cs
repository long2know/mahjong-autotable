...
namespace Mahjong.Autotable.Api.Persistence.Migrations.SqlServer
{
    ...
    public partial class Phase_K_W3_VoiceAndOnboardingSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_PlayerSeasonRolloverDeferrals_PlayerId_FromSeason_TournamentId",
                table: "PlayerSeasonRolloverDeferrals",
                newName: "IX_PlayerSeasonRolloverDeferrals_PlayerId_FromSeasonId_TournamentId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastStepCompletedUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                name: "IX_PlayerSeasonRolloverDeferrals_PlayerId_FromSeasonId_TournamentId",
                table: "PlayerSeasonRolloverDeferrals",
                newName: "IX_PlayerSeasonRolloverDeferrals_PlayerId_FromSeason_TournamentId");
        }
    }
}
