        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromSeason = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    ToSeason = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    DeferredAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TournamentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DrainedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
