        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlayerId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    OldTokenId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NewTokenId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Ipv4Hash = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RotatedFromTokenId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByPlayerId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    MaxPlayers = table.Column<int>(type: "int", nullable: false),
                    GamesPerMatch = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Player1Id = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Player2Id = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    Player3Id = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    Player4Id = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    WinnerPlayerId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    GameIdsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CompletedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
