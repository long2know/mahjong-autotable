...
## Archived 2026-06-19 -- 30-day gate (Tier 1): foundational + pre-Phase-H decisions (2026-04-20 -> 2026-05-20)

> Relocated from decisions.md by Scribe on 2026-06-19 (decisions.md was 1550871 B >= 20480 B). Spans Active Decisions (project baselines: .NET 10/EF Core/SQLite-flexible, single Docker image, F5 dev-loop, React/Fluent/Vite), Changsha v1 audits/governance/spec-lock, MahjongPros canonical source, opus-4.7 model directive, 3D renderer spike, Ripley architectural pivot plan, and Phases B-G. Some 2026-04-20..05-13 entries may duplicate the prior archived era above.
